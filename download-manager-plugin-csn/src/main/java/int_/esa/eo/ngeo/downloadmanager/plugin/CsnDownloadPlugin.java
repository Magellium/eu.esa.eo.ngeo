...
public class CsnDownloadPlugin implements IDownloadPlugin {
    ...
    public IDownloadPluginInfo initialize(File tmpRootDir, File pluginCfgRootDir) throws DMPluginException {
        pluginConfig = pluginConfigurationLoader.loadPluginConfiguration(CsnDownloadPlugin.class.getName(), pluginCfgRootDir);
        createSchemaRepository();

        CsnDownloadPluginInfo pluginInfo = new CsnDownloadPluginInfo();
    ...
    public IDownloadProcess createDownloadProcess(URI productURI,
        ...
        return new CsnDownloadProcess(productURI, downloadDir, downloadListener, umSsoHttpConnectionSettings, pluginConfig, schemaRepository);
    }
