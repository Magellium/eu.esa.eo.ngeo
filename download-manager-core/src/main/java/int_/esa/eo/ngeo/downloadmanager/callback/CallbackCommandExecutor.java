...
import int_.esa.eo.ngeo.downloadmanager.callback.CommandLineExecutor.CommandResultHandler;
    ...
    public void invokeCallbackCommandOnProductFiles(String unresolvedCommand, File[] downloadedFiles) {
        ...
        if (unresolvedCommand.contains(FILESET_MACRO_REF)) {
            ...
            for (File file : downloadedFiles) {
                ...
                // FIXME: Specification of the shell wrapper needs to cope with MacOS and Linux/Unix (and maybe Win95...)
                CommandLine commandLine = new CommandLine(getOSShellName());
