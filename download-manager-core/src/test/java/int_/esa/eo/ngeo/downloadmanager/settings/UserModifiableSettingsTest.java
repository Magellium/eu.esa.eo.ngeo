...
public class UserModifiableSettingsTest {

	private Properties nonUserModifiableProperties = new Properties();

	@Before
	public void setup() throws IOException {
		InputStream in = SettingsManager.class.getResourceAsStream("/META-INF/user-modifiable-settings.properties");
		nonUserModifiableProperties.load(in);
	}
	
	@Test
	public void testUserModifiableSettingsAgainstDefaultProperties() {
		List<String> enumValuesWithoutCorrespondingPropertyEntries = new ArrayList<>();
		StringBuilder errorMessage = new StringBuilder();
		
		List<String> enumValues = enumValues(UserModifiableSetting.class);
