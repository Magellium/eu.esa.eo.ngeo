...
public class MagelliumBootstrap {
	...
	public MagelliumBootstrap(String[] args) throws IOException {
		...
		for (CommandMarker command : commands.values()) {
			if (!command.equals(shell) // This filters out the "standard" commands of AbstractShell
	...
	public static void main(String[] args) throws IOException {
		MagelliumBootstrap magelliumBootstrap = new MagelliumBootstrap(args);
		magelliumBootstrap.run();
	}
