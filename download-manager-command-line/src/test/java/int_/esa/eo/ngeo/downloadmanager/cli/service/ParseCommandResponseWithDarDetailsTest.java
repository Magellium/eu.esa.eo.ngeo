...
public class ParseCommandResponseWithDarDetailsTest {
    ...
    public void parseCommandResponseWithDarDetailsTest200() throws IOException, ServiceException {
        ...
        CommandResponseWithDarDetails commandResponseWithDarDetails = downloadManagerResponseParser.parseCommandResponseWithDarDetails(conn);
        assertTrue(commandResponseWithDarDetails.isSuccess());
        assertEquals("", commandResponseWithDarDetails.getErrorMessage());
        assertEquals("abcdefg", commandResponseWithDarDetails.getDarUuid());
    }
