...
SET SYS_PROPS=-DDM_HOME="%DM_HOME%\" -Djava.net.preferIPv4Stack=true -Djavax.net.ssl.trustStore="%DM_HOME%conf\dmtu-truststore.jks" -Dlog4j.configuration="file:\%DM_HOME%conf\log4j.xml"
