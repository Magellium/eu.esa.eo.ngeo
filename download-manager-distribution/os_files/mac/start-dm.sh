...
$DM_HOME/jre/jre1.7.0_21/bin/java $SYS_PROPS -jar "$DM_HOME/bin/download-manager-webapp-jetty-console.war" --headless --port $DM_PORT --contextPath /download-manager