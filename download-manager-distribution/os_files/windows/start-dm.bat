...
set MYCOMMAND="%DM_HOME%jre\jre1.7.0_21\bin\java" %SYS_PROPS% %DEBUG_OPTIONS% -jar "%DM_HOME%bin\download-manager-webapp.war" --headless --port %DM_PORT% --contextPath /download-manager
